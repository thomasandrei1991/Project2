...
<head>
    ...
    <title>Order Details — ShopGreen</title>
    <link rel="stylesheet" 
...
<body>
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            ...
            <span>Order #<?php echo str_pad(
                $order_id, 5, '0', STR_PAD_LEFT); ?></span>
        </div>
        ...
        <div class="success-grid">
            ...
            <div class="checkout-card">
                ...
                <div class="summary-row">
                    ...
                    <span>₱<?php echo number_format(
                        $order['total'] - ($order['total'] >= 1000 ? 0 : 80),
                        2); ?></span>
                </div>
                <div class="summary-row">
                    <span>Shipping</span>
                    <span><?php echo $order['total'] >= 1000
            ...
            <div class="checkout-card">
                ...
                <div class="delivery-detail-row">
                    <span class="dd-label">Order Date</span>
                    <span class="dd-value">
