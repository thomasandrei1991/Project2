                ...
                <div class="admin-card">
                    <form method="POST" action="<?php echo BASE_URL; ?>admin/actions/save_product.php" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>Stock *</label>
                                <input type="number" name="stocks" min="0" value="<?php echo $product['stocks']; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Current Image</label><br>
                            <?php if (!empty($product['image'])): ?>
                                <img src="<?php echo BASE_URL; ?>assets/images/<?php echo htmlspecialchars($product['image']); ?>" style="height:100px; border-radius:8px; margin-bottom:8px; display:block;">
                                <?php else: ?>
                                <p style="color:var(--gray-text); font-size:0.9rem;">No image uploaded</p><?php endif; ?>
